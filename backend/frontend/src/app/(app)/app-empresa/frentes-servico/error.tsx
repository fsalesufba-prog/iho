...
export default function FrentesServicoError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página de frentes de serviço:', error)
  }, [error])
    ...
    <Container size="sm" className="min-h-[70vh] flex items-center justify-center">
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-2">
          Erro ao carregar frentes de serviço
        </h1>
        
        <p className="text-muted-foreground mb-6">
          Não foi possível carregar a lista de frentes de serviço.
          {error.message && (
