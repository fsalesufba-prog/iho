...
import { AlertTriangle, RefreshCw, ArrowLeft, Home, TrendingUp } from 'lucide-react'
...
export default function PrevisaoError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página de previsão:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar os dados de previsão.'}
                  </motion.p>
