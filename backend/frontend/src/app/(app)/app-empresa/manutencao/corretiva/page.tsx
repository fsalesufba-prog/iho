...
export default function ManutencaoCorretivaPage() {
  ...
  const [manutencoes, setManutencoes] = useState<ManutencaoCorretiva[]>([])
  ...
  const [selectedManutencao, setSelectedManutencao] = useState<ManutencaoCorretiva | null>(null)
  ...
  const carregarManutencoes = async () => {
    try {
      ...
      toast({
        ...
        description: 'Não foi possível carregar a lista de manutenções corretivas.',
        variant: 'destructive'
      })
    } finally {
      setLoading(false)
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'A manutenção corretiva foi excluída com sucesso.'
      })
  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-y-auto bg-background">
        <Header title="Manutenção Corretiva" />
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Gerencie as manutenções corretivas em andamento
              </p>
            </div>

            {(user?.tipo === 'adm_empresa' || user?.tipo === 'controlador') && (
              <Link href="/app-empresa/manutencao/corretiva/nova">
                <Button className="group bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            {searchTerm || statusFiltro !== 'todos' || prioridadeFiltro !== 'todos'
                              ...
                              : 'Comece registrando a primeira manutenção corretiva'}
                          </p>
                          {(user?.tipo === 'adm_empresa' || user?.tipo === 'controlador') && (
                            <Link href="/app-empresa/manutencao/corretiva/nova">
                              <Button>
