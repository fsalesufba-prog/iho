...
import { AlertTriangle, RefreshCw, ArrowLeft, Home, Wrench } from 'lucide-react'
...
export default function ManutencaoDetalheError({
  error,
  reset,
}: {
  ...
  const manutencaoId = params?.id

  useEffect(() => {
    console.error('Erro na página de detalhe da manutenção:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar os dados da manutenção.'}
                  </motion.p>
