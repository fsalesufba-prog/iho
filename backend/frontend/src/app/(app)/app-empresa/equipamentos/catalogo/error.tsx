...
export default function CatalogoEquipamentosError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página do catálogo:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar o catálogo de equipamentos.'}
                  </motion.p>
