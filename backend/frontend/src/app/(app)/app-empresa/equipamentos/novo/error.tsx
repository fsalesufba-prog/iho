...
export default function NovoEquipamentoError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página de novo equipamento:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar o formulário de cadastro.'}
                  </motion.p>
