...
import { useState, useEffect, useRef } from 'react'  // <-- ADICIONA useRef AQUI
...
export default function RelatorioTipoPage() {
  ...
  const printRef = useRef<HTMLDivElement>(null)  // <-- CRIA A REF AQUI
    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto bg-background print:overflow-visible">
        ...
        <Container size="xl" className="py-8 print:py-4">
          ...
          {/* Relatório */}
          <Card ref={printRef}>  {/* <-- USA A REF AQUI */}
            <CardHeader>
