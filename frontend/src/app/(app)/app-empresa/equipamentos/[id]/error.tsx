...
export default function EquipamentoDetalheError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página de detalhe do equipamento:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar os dados do equipamento.'}
                  </motion.p>
