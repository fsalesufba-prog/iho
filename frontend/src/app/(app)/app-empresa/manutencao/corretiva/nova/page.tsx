  ...
  const onSubmit = async (data: ManutencaoFormData) => {
    try {
      ...
      toast({
        ...
        description: 'A manutenção corretiva foi registrada com sucesso.'
      })

      router.push('/app-empresa/manutencao/corretiva')
    } catch (error: any) {
      toast({
        title: 'Erro ao criar',
  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-y-auto bg-background">
        <Header title="Nova Manutenção Corretiva" />
        ...
        <Container size="xl" className="py-8">
          ...
          {showAlert && (
            <Alert variant="destructive" className="mb-6">
              ...
              <AlertDescription>
                Atenção: Manutenções corretivas são urgentes. Priorize o atendimento.
              </AlertDescription>
            </Alert>
          )}
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dataProgramada">Data da Ocorrência *</Label>
                      <Input
                        id="dataProgramada"
                        type="date"
