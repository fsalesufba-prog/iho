...
import { AlertTriangle, RefreshCw, ArrowLeft, Home, Activity } from 'lucide-react'
...
export default function IndicadoresError({
  ...
  useEffect(() => {
    console.error('Erro na página de indicadores:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar os dados dos indicadores.'}
                  </motion.p>
