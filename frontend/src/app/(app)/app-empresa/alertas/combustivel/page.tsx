...
export default function AlertasCombustivelPage() {
  ...
  const [selectedAlerta, setSelectedAlerta] = useState<AlertaCombustivel | null>(null)
  ...
  const carregarAlertas = async () => {
    try {
      setLoading(true)
      const response = await api.get('/alertas/combustivel', {
  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-y-auto bg-background">
        <Header title="Alertas de Combustível" />
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Monitore consumo elevado de combustível
              </p>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Não há alertas de consumo elevado no momento
                  </p>
                </div>
              ) : (
                <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-start justify-between">
                                ...
                                <>
                                  <div>
                                    ...
                                    <span className="ml-2 font-bold text-red-600">
                                      {alerta.valor.toFixed(2)} L
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-muted-foreground">Limite:</span>
                                    <span className="ml-2">{alerta.limite} L</span>
                                  </div>
                                </>
                              )}
                            </div>
                        ...
                        <div className="flex gap-2">
                          <Link href={`/app-empresa/alertas/combustivel/${alerta.id}`}>
      ...
      <Dialog open={resolucaoDialogOpen} onOpenChange={setResolucaoDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Resolver Alerta de Combustível</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={ignorarDialogOpen} onOpenChange={setIgnorarDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Ignorar Alerta de Combustível</DialogTitle>
            <DialogDescription>
