...
>>>>>>> bdb1570aee94106fe89b815342989cef5cb183be
  ...
  const [selectedAlerta, setSelectedAlerta] = useState<AlertaEstoque | null>(null)
  ...
  const carregarAlertas = async () => {
    try {
      setLoading(true)
      const response = await api.get('/alertas/estoque', {
  ...
  return (
    <>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Monitore itens com estoque baixo ou esgotado
              </p>
            </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-2 text-sm">
                              <div>
                                ...
                                <span className="ml-2 font-medium">{alerta.itemEstoque.nome}</span>
                              </div>
                              <div>
                                <span className="text-muted-foreground">Código:</span>
                                <span className="ml-2 font-mono">{alerta.itemEstoque.codigo}</span>
                              </div>
                              <div>
                                <span className="text-muted-foreground">Categoria:</span>
                                <span className="ml-2">{alerta.itemEstoque.categoria}</span>
                              </div>
                        ...
                        <div className="flex gap-2">
                          <Link href={`/app-empresa/alertas/estoque/${alerta.id}`}>
      ...
      <Dialog open={resolucaoDialogOpen} onOpenChange={setResolucaoDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Resolver Alerta de Estoque</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={ignorarDialogOpen} onOpenChange={setIgnorarDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Ignorar Alerta de Estoque</DialogTitle>
            <DialogDescription>
