...
import { AlertTriangle, RefreshCw, ArrowLeft, Home, Package } from 'lucide-react'
...
export default function AlmoxarifadoError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Erro na página de almoxarifado:', {
            ...
            <Card className="max-w-2xl w-full">
              <CardContent className="p-8">
                ...
                >
                  ...
                  >
                    {error.message || 'Não foi possível carregar os dados do almoxarifado.'}
                  </motion.p>
