...
export default function AlmoxarifadoPage() {
  ...
  const carregarStats = async () => {
    try {
      const response = await api.get('/almoxarifado/stats')
        ...
        <Container size="xl" className="py-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Gerencie o estoque de peças e insumos
              </p>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-yellow-600">{stats.itensBaixoEstoque}</p>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            ...
            <Link href="/app-empresa/almoxarifado/analise/consumo">
              <Card className="hover:shadow-lg transition-all cursor-pointer group">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm font-medium">Análise de Consumo</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/app-empresa/almoxarifado/analise/estoque-minimo">
              <Card className="hover:shadow-lg transition-all cursor-pointer group">
                <CardContent className="p-4 text-center">
                  <AlertCircle className="h-8 w-8 mx-auto mb-2 text-yellow-600 group-hover:scale-110 transition-transform" />
                  <p className="text-sm font-medium">Estoque Mínimo</p>
                </CardContent>
              </Card>
            </Link>

            <Link href="/app-empresa/almoxarifado/relatorios">
              <Card className="hover:shadow-lg transition-all cursor-pointer group">
                <CardContent className="p-4 text-center">
                  <Download className="h-8 w-8 mx-auto mb-2 text-purple-600 group-hover:scale-110 transition-transform" />
