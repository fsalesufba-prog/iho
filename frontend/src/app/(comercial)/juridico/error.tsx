...
import { AlertTriangle, RefreshCw, Home, ArrowLeft, Scale } from 'lucide-react'
...
export default function JuridicoError({
  ...
  useEffect(() => {
    console.error('Erro na página jurídica:', error)
  }, [error])
      ...
      <Container size="sm">
        ...
        >
          <div className="relative mb-6">
            ...
            >
              <Scale className="h-20 w-20 text-destructive" />
            </motion.div>
          </div>
